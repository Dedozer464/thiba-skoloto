...
<title> Thiba skoloto v2 — the anti mashonisa tool</title>
...
.logo-icon{
  ...
  background:linear-gradient(135deg,#db16b1,#7f1d1d);
...
/* ── PANEL ── */
.panel{background:#0f0fd6;border:1px solid #178617;border-radius:12px;padding:22px}
.sec-label{
  font-size:10px;font-family:'DM Mono',monospace;
  color:#246fd8;letter-spacing:3px;font-weight:600;
...
<div id="app">
  ...
  <header>
    <div class="logo">
      ...
      <span class="logo-text">Thiba skoloto</span>
...
// ── AREA CHART (SVG) ─────────────────────────────────────────────────────────
function renderAreaChart(schedule, totalPaid, principal) {
  const svg
